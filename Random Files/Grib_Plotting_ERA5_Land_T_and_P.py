...
#Read the GRIB File
grbs = pygrib.open("C:/Users/frumkina/Desktop/Python/Grib Files/T2m_Precip_2018_2019.grib")

#Check the first few messages
for grb in grbs.select(name='2 metre temperature')[-48:]:
    print(grb)
...
Data_File = open('C:/Users/frumkina/Desktop/Python/Grib Files/Cordinate Lists/T2m_Precip_2018_2019.txt',"w")
...
m = Basemap(resolution='i', projection='tmerc',llcrnrlon=-81,llcrnrlat=32.1,urcrnrlon=-78.8,urcrnrlat=34,lat_0=33.05,lon_0=-79.75)
x,y = m(lons,lats)
m.drawcoastlines()
m.drawstates()
m.drawcountries()
cs = m.contourf(x,y,t2m,np.linspace(230,300,41),cmap=plt.cm.jet,extend='both')
t = plt.title('2m Temoerature')
